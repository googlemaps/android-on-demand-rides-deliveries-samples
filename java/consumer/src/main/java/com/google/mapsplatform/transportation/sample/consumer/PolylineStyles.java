...
/** Class with utility methods that deal with polyline styling for a consumer map. */
final class PolylineStyles {
  private static final TrafficStyle TRAFFIC_STYLE =
  ...
  /**
   * Applies traffic styling for the "Active route" polyline. This enables the "Traffic Aware
   * Polyline" feature.
   *
   * @param consumerController the map controller which provides access to the styles configurator.
   */
  public static void enableTrafficAwarePolyline(ConsumerMapStyle consumerMapStyle) {
